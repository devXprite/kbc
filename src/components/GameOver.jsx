        ...
        <div>
            ...
            {score != null
                ...
                : <>
                    ...
                    <p className="px-4 text-justify mt-16 max-w-4xl text-base md:text-xl" >
            ...
            <button className='bg-violet-700 text-xl md:text-2xl border-0 block mx-auto mt-16 rounded-lg py-2 px-8' onClick={() => { dispatch(newGame()) }} >Start New Game</button>
        </div>
    );
}
